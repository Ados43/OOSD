...
public class MainView {
    ...
    @FXML
    private void onPlayTetris(ActionEvent event) {

        // Set up game
        ApplicationController controller = (ApplicationController) playButton.getScene().getWindow().getUserData();

        // Set up view
        Parent root = controller.playGame(controller); // createContent()
    ...
    private void goBackToMenu(Stage stage) throws IOException {

        javafx.fxml.FXMLLoader loader =
                new javafx.fxml.FXMLLoader(MainView.class.getResource("main-menu.fxml"));
